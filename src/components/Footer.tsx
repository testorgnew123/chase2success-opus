      ...
      <div className="border-t border-border">
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-muted-foreground font-sans max-w-2xl">
            <span className="font-semibold">RERA Disclaimer:</span> RERA No: XXXXXXXXXX. All projects are RERA registered. Buyers are advised to verify all details independently before making any purchase decision.
          </p>
        ...
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <a href="https://www.linkedin.com/company/kyleinnovate" target="_blank" rel="noopener noreferrer"
              className="w-8 h-8 border border-border rounded-full flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-colors">
